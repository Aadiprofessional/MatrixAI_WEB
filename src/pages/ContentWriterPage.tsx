              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="w-full bg-green-50 dark:bg-green-900/20 rounded-lg p-3 text-xs text-gray-700 dark:text-gray-300 border border-green-100 dark:border-green-800/50">
                  <div className="flex items-start">
                    ...
                    <span><strong>Note:</strong> All content generated by our AI is original and created specifically for your prompt. Please review and edit as needed to match your specific requirements and style preferences.</span>
                  </div>
                </div>
